 ...
 * 36 patterns across 8 categories + 19 regulation mappings.
 *
...
export const PATTERNS: SecurityUXPattern[] = [
  ...
  {
    id: "ai/input-safety",
    label: "AI Input Safety",
    category: "AI",
    tags: ["EU AI Act", "OWASP LLM01", "CWE-77", "prompt injection", "rate limiting", "input validation"],
    url: "https://uxsec.dev/patterns/ai/input-safety",
    relevantUISignals: ["chat input", "prompt", "send message", "type a message", "ask anything", "upload", "attach", "microphone", "voice input", "code input"],
  },
  {
    id: "ai/human-override",
    label: "Human Override & AI Kill Switch",
    category: "AI",
    tags: ["EU AI Act Art. 14", "GDPR Art. 22", "high-risk AI", "human oversight", "emergency stop"],
    url: "https://uxsec.dev/patterns/ai/human-override",
    relevantUISignals: ["override", "human review", "appeal", "escalate", "pause", "stop", "kill switch", "emergency stop", "manual review", "approve", "reject", "decision queue"],
  },
...
export const REGULATIONS: RegulationMapping[] = [
  ...
  { id: "euaiact", name: "EU AI Act", fullName: "EU Artificial Intelligence Act — Article 50 Transparency (Aug 2026)", patternIds: ["ai/disclosure", "ai/content-labeling", "ai/decision-explanation", "ai/input-safety", "ai/human-override", "auth/accessible-auth", "data/activity-log", "owasp/logging-monitoring"] },
  { id: "usai", name: "US AI Laws", fullName: "Colorado AI Act + California AI Transparency Act (2026)", patternIds: ["ai/disclosure", "ai/content-labeling", "ai/decision-explanation", "ai/input-safety", "ai/human-override"] },
  ...
  { id: "iso42001", name: "ISO/IEC 42001", fullName: "AI Management System — Responsible AI Governance (2023)", patternIds: ["ai/disclosure", "ai/content-labeling", "ai/decision-explanation", "ai/input-safety", "ai/human-override", "governance/design-review", "governance/change-management", "governance/compliance-audit", "data/activity-log", "owasp/logging-monitoring", "owasp/security-misconfiguration"] },
];
...
export function buildPatternKnowledgeBase(): string {
  ...
  lines.push("# Security UX Pattern Library (uxsec.dev) — 36 Patterns\n");
